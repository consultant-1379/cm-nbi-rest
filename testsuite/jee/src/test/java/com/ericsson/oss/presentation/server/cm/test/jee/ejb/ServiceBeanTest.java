 ...
 *******************************************************************************
 *----------------------------------------------------------------------------*/
package com.ericsson.oss.presentation.server.cm.test.jee.ejb;
...
import com.ericsson.oss.presentation.server.cm.api.Service;
import com.ericsson.oss.presentation.server.cm.ejb.ServiceBean;
import com.ericsson.oss.presentation.server.cm.ejb.ServiceLocal;
import com.ericsson.oss.presentation.server.cm.impl.DateResolverBean;
import com.ericsson.oss.presentation.server.cm.test.jee.Artifact;
...
public class ServiceBeanTest {
    ...
    public static Archive<?> createTestArchive() {
        final PomEquippedResolveStage resolver = Artifact.getResolver();
